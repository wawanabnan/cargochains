# billing/views/vendor_payment.py
...
from billing.forms.vendor_payments import VendorPaymentForm, VendorPaymentLineFormSet
from billing.models.vendor_payment import VendorPayment
...
class VendorPaymentCreateView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        return render(request, "vendor_billing/form.html", {"form": form, "formset": formset, "mode": "add"})
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            return redirect("billing:vendor_payment_edit", pk=obj.pk)
