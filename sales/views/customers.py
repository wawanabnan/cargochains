...
class CustomerListView(LoginRequiredMixin, EntityContextMixin, CustomerQuerysetMixin, ListView):
    model = Partner
...
class CustomerCreateView(LoginRequiredMixin, EntityContextMixin, CreateView):
    model = Partner
...
class CustomerUpdateView(LoginRequiredMixin, EntityContextMixin, CustomerQuerysetMixin, UpdateView):
    model = Partner
    form_class = CustomerForm
    template_name = "customers/form.html"
...
class CustomerDetailView(LoginRequiredMixin, EntityContextMixin, CustomerQuerysetMixin, DetailView):
    model = Partner
...
class CustomerDeleteView(LoginRequiredMixin, EntityContextMixin, CustomerQuerysetMixin, DeleteView):
    model = Partner
